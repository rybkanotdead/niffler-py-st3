"""
Тесты для страницы трат (Spending Page).
Проверяют функциональность добавления, редактирования и удаления трат.
Используют фикстуры для логина и очистки данных.
"""
import random
import time
